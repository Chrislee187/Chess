...
namespace Chess.Common.Movement
{
    public class KingMoveGenerator : MoveGeneratorBase
    {
        ...
        private IEnumerable<Move> Castles(Common.Board board, BoardLocation kingLocation)
        {
        ...
        private static List<Move> CreateCastleMoveIfAllowed(Common.Board board, BoardLocation kingLocation, BoardLocation rookLocation,
