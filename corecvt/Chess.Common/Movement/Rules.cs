...
//                .Add("friendly-pawn-destination-is-empty", (board, move) => board.IsEmptyAt(move.To))
        ...
        public static bool DestinationIsEnemyPawn(Common.Board board, Move move)
        {
        ...
        public static bool PawnBeingTakeWithEnpassantHasCorrectMoveHistory(Common.Board board, Move move)
        {
            var newFile = move.To.File;
            var takeLocation = new BoardLocation(newFile, move.From.Rank);
