...
namespace chess.pgn.tests
{
    ...
    public class Tests
    {
        ...
        public void Spike()
        {
            var pgnContents = WikiPgnGameText;
            var pgnFilename = "";

            var reader = PgnReader.FromString(pgnContents +"\n" + pgnContents);
            //            var reader = PgnReader.FromFile(pgnContents);
            ...
            while (pgnGame != null)
            {
                ...
                Assert.That(pgnGame.Turns.Single(t => t.Turn == 3).Black.Comment, Is.EqualTo("This opening is called the Ruy Lopez"));
        ...
        public const string WikiPgnGameText = "[Event \"F/S Return Match\"]\n" +
