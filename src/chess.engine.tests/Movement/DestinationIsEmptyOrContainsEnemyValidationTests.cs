...
namespace chess.engine.tests.Movement
{
    ...
    public class DestinationIsEmptyOrContainsEnemyValidationTests
    {
        ...
        public void Should_return_true_for_move_to_empty_space()
        {
            ...
            Assert.True(_validator.ValidateMove(empty, DestinationIsEmptyOrContainsEnemyValidator<ChessPieceEntity>.Wrap(_boardState)));
        }
        ...
        public void Should_return_false_for_move_to_own_piece()
        {
            ...
            Assert.False(_validator.ValidateMove(notEmpty, DestinationIsEmptyOrContainsEnemyValidator<ChessPieceEntity>.Wrap(_boardState)));
        }
    }
}