...
namespace CSharpChess.Movement
{
    ...
    ///  
    ///  MoveGenerator results should only be made available through an instance of <see cref="CSharpChess.Board"/> which 
    ...
    /// 
    ///  Therefore the board will be resposible for managing this behaviour. See <see cref="CSharpChess.Board.RemoveMovesThatLeaveBoardInCheck"/>
    ///  </remarks>
    ///  </summary>
    public abstract class MoveGeneratorBase : IMoveGenerator
    {
        public virtual IEnumerable<Move> All(CSharpChess.Board board, BoardLocation at)
        {
        ...
        /// </summary>
        protected abstract IEnumerable<Move> ValidMoves(CSharpChess.Board board, BoardLocation at);
        /// <summary>
        /// "Takes" are normal taking moves
        /// </summary>
        protected abstract IEnumerable<Move> ValidCovers(CSharpChess.Board board, BoardLocation at);
        /// <summary>
        /// "Covers" are NOT actual moves but a list of any locations containing friendly pieces that
        /// this piece could attack.
        /// </summary>
        protected abstract IEnumerable<Move> ValidTakes(CSharpChess.Board board, BoardLocation at);

        protected delegate bool DestinationCheck(CSharpChess.Board board, BoardLocation from, BoardLocation to);

        protected static IEnumerable<Move> AddTransformationsIf(CSharpChess.Board board,
            BoardLocation from,
