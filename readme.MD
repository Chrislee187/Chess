...
* The [chess.engine.tests][link.chess.engine.tests] which contains all the tests, needs to be split up a bit.
...
* So... I've used and loved Linq for years, but it does create quite the rabbit hole sometimes.
